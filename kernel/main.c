...
startothers(void)
{
  //"_binary_out_entryother_start" is generated by the linker based on the dir
  ...
  code = p2v(0x7000);
  memmove(code, _binary_out_entryother_start, (uint64)_binary_out_entryother_size);
  ...
  for(c = cpus; c < cpus+ncpu; c++){
    ...
    // this part changed a lot. must research
